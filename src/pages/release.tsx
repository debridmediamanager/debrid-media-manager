...
function ReleasePage() {
	...
	const fetchData = async (searchQuery: string) => {
		...
		try {
			...
			const response = await axios.get<BtDiggApiResult>('/api/release', {
				params,
	...
	return (
		<div className="mx-4 my-8">
			...
			<div className="flex justify-between items-center mb-4">
				<h1 className="text-3xl font-bold">Scene Release Search</h1>
				<Link
					href="/"
			...
			<form onSubmit={handleSubmit}>
				<div className="flex items-center border-b border-b-2 border-gray-500 py-2">
					<input
						...
						type="text"
						id="query"
						placeholder="scene release name e.g. Tetris.2023.iTALiAN.HDR.2160p.WEB.H265-NTROPiC"
						value={query}
