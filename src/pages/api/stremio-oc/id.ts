...
// log or a proxy cache key. An Offcloud key is the whole account - no scoping,
// no per-app keys - and it also authenticates as `?key=` upstream, so keeping
// it out of URLs is the only thing standing between a leak and a takeover.
