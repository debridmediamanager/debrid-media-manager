	...
	return (
		<div className="flex min-h-screen flex-col items-center justify-center bg-gray-900 p-4">
			...
			<Image
				...
				className="mb-4"
			/>
			<h1 className="mb-4 text-2xl font-bold text-green-400">DMM Cast for Real-Debrid</h1>
			<div className="flex flex-col items-center text-white">
				...
				{dmmCastToken !== 'default' && (
					<div className="mb-4 mt-4 h-max text-center leading-8">
						<Link
							...
							className="text-md haptic-sm m-1 rounded border-2 border-green-500 bg-green-800/30 px-4 py-2 font-medium text-gray-100 transition-colors hover:bg-green-700/50"
						>
							<Wand2 className="mr-1 inline-block h-4 w-4 text-green-400" />
							Install
						</Link>
						<Link
				...
				<CastSettingsPanel service="rd" accentColor="green" />
			</div>
			...
			<div className="mt-6 flex gap-4">
				{dmmCastToken !== 'default' && (
					<Link
						href="/stremio/manage"
						className="haptic-sm rounded border-2 border-green-500 bg-green-800/30 px-4 py-2 text-sm font-medium text-green-100 transition-colors hover:bg-green-700/50"
					>
						<span className="inline-flex items-center">
