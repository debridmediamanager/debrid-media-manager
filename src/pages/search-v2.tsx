import TMDBPoster from '@/components/poster';
				...
				<>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
						{searchResults.map((result) => (
							<div key={result.id} className="shadow-lg rounded-lg p-4">
								<TMDBPoster imdbId={result.imdbid} />
								<h3 className="font-bold mt-2">{result.title}</h3>
