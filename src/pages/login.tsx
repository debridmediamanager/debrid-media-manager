  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <div className="my-8 text-center">
        ...
        <p className="text-lg">This is the true media collection with unlimited storage size</p>
      </div>

      {/* Login Buttons */}
      <div className="flex flex-col items-center">
        <p className="text-sm">Please login with one of the supported Debrid services below:</p>
        {/* RealDebrid */}
        <div className="flex flex-row">
          ...
          <a
            ...
            href="https://www.real-debrid.com/register"
            target="_blank"
