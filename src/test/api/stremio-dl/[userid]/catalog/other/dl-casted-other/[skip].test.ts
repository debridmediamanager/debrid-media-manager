import handler from '@/pages/api/stremio-dl/[userid]/catalog/other/dl-casted-other/[skip]';
...
vi.mock('@/utils/debridLinkCastCatalogHelper', async () => {
	...
	return { ...actual, getDebridLinkDMMLibrary: vi.fn() };
});

const mockLibrary = vi.mocked(getDebridLinkDMMLibrary);

describe('/api/stremio-dl/[userid]/catalog/other/dl-casted-other/[skip]', () => {
