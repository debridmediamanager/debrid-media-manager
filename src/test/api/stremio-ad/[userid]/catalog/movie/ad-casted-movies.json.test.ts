import handler from '@/pages/api/stremio-ad/[userid]/catalog/movie/ad-casted-movies.json';
...
describe('/api/stremio-ad/[userid]/catalog/movie/ad-casted-movies.json', () => {
	let res: ReturnType<typeof createMockResponse>;

	beforeEach(() => {
		vi.clearAllMocks();
		res = createMockResponse();
		mockRepository.fetchAllDebridCastedMovies = vi.fn();
	});

	it('sets CORS header', async () => {
		mockRepository.fetchAllDebridCastedMovies = vi.fn().mockResolvedValue([]);
