...
import handler from '@/pages/api/stremio-ad/cast/updateSizeLimits';
...
describe('API /api/stremio-ad/cast/updateSizeLimits', () => {
	...
	it('saves profile and returns success', async () => {
		...
		expect(mockDb.saveAllDebridCastProfile).toHaveBeenCalledWith(
			'user-123',
			'valid-key',
			5000,
			2000,
