import handler from '@/pages/api/stremio-oc/[userid]/catalog/other/oc-casted-other/[skip]';
...
vi.mock('@/utils/offcloudCastCatalogHelper', async () => {
	...
	return { ...actual, getOffcloudDMMLibrary: vi.fn() };
});

const mockLibrary = vi.mocked(getOffcloudDMMLibrary);

describe('/api/stremio-oc/[userid]/catalog/other/oc-casted-other/[skip]', () => {
