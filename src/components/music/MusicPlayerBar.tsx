...
export default function MusicPlayerBar({
	...
	return (
		<div className="fixed bottom-4 left-4 right-4 z-50 animate-slide-up rounded-xl border border-white/10 bg-black/80 px-5 py-3 shadow-music-2xl backdrop-blur-xl">
