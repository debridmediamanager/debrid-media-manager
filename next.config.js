...
const nextConfig = {
	...
	publicRuntimeConfig: {
		...
		realDebridHostname: window.hostname.includes('localhost') ? 'https://api.real-debrid.com' : 'https://proxy.debridmediamanager.com/anticors?url=https://api.real-debrid.com',
