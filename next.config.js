...
const nextConfig = {
	...
	publicRuntimeConfig: {
		...
		realDebridHostname: (typeof window !== 'undefined' && window.location.hostname.includes('localhost'))
        ? 'https://api.real-debrid.com'
        : 'https://proxy.debridmediamanager.com/anticors?url=https://api.real-debrid.com',
